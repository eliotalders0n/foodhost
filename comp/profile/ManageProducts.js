...
function ManageProducts() {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      <Text style={{ paddingHorizontal: 20, ...FONTS.h4, color: COLORS.black }}>
        {item.produce}
      </Text>
      <Text style={{ paddingHorizontal: 20, ...FONTS.h6, color: COLORS.black }}>
        {item.produce_category}
      </Text>
      <Text
        style={{ paddingHorizontal: 20, ...FONTS.h6, color: COLORS.secondary }}
      >
        Price: {item.price}
      </Text>
    </TouchableOpacity>
